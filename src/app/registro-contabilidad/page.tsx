...
export default function RegistroContabilidadPage() {
  ...
  const filtrosOrdenes = useMemo(() => ({
    ...
    autoContabilidad: filtroContabilidad === "TODOS" ? undefined : filtroContabilidad === "APROBADO",
  }), [filtroEstado, fechaFiltro, filtroContabilidad]);
  ...
  // Búsqueda, estado, fecha y aprobación de contabilidad ya se resuelven en
  // el servidor vía Elasticsearch (ver loadOrdenesCompra/loadOrdenesServicio).
